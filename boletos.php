    ...
    <body>
            ...
            <div id="container">
                ...
                <nav>
                    <ul>
                        ...
                        <li><a href="boletos.html" class="selected">Comprar Boletos</a></li>
                    </ul>
                </nav>
            </div>
        </header>
        <main>
            ...
            <section id="main-info">
                <div id="container">
                    <h2><span>NUESTROS EVENTOS</span></h2>
                    <p>
                ...
                ?>
                    <!-- <div id="container">
                        <div class="item-col">
                            ...
                            <h5>NO PERDAMOS LA FE</h5>
                            <p id="social-text">$300.00</p>
                        </div>
                        <div class="item-col">
                            <p class="top-left">New</p>
                            <a href="event_detail.html"><img src="imagenes/minibaner1.jpg" alt=""></a>
                            <h5>LA IMPORTANCIA DE LOS ALIMENTOS</h5>
                            <p id="social-text">$300.00</p>
                        </div>
                        <div class="item-col">
                            <p class="top-left">New</p>
                            <a href="event_detail.html"><img src="imagenes/minibaner2.jpg" alt=""></a>
                            <h5>EDUCANDO PARA EL FUTURO</h5>
                            <p id="social-text">Entrada Gratis</p>
                        </div>
                        <div class="item-col">
                            <p class="top-left">New</p>
                            <a href="event_detail.html"><img src="imagenes/minibaner3.jpg" alt=""></a>
