    ...
    <body>
        <header>
            <div id="container">
                ...
                <nav>
                    <ul>
                        <li><a href="home_business.html">Incio</a></li>
                        <li><a href="profile_business.html" class="selected">Fundacion</a></li>
                    </ul>
                </nav>
            </div>
        </header>
            ...
            <section id="contact-form">
                ...
                <form>  
                    ...
                    <div class="upload-pic">
                        <table>
                            <tr>
                                <td><img src="imagenes/nologo.png" alt=""></td>           
                            </tr>
                            <tr>
