  <main>
    <section id="contact-main">
      <div id="container">
          <h1>CONTACT</h1>
          <h3><span>INCIO</span> CONTACTO</h3>
      </div>
    </section>   
    <section id="contact-info">
      <div id="container">
        <h1>Informatión del contacto</h1>
      ...
      <div id="container">
        <h1>LEAN en las redes sociales</h1>
          <div class="contact-col">
            ...
            <p id="social-text">LEAN Ayuda Humanitaria</p>
          </div>
          <div class="contact-col">
            <img src="imagenes/twitter.png" alt="">
            <p id="social-text">@LeanEmergente</p>
          </div>
          <div class="contact-col">
            <img src="imagenes/instagram.png" alt="">
            <p id="social-text">@LeanAyudaHumanitaria</p>
          </div>
          <div class="contact-col">
            <img src="imagenes/correo.png" alt="">
            <p id="social-text">lean emergente@gmail.com</p>
          </div>
      </div>
    </section> 
    <section id="contact-form">
      <div class="wrap-form">
        ...
        <form name="contact" action="./validate-contact.php" onsubmit="return validateForm()" method="POST">  
          ...
          <div class="apellido halfright-textbox">
          ...
          <input type="text" id="tema" name="tema" placeholder="Su asunto de este mensaje" required> 

          <label for="mensaje">Mensaje</label>
          <textarea rows="14" id="mensaje" name="mensaje" placeholder="Di algo sobre nosotros"></textarea>
...
<script>
  function validateForm(){
        var correo = document.forms["contact"]["correo"];
        var tema = document.forms["contact"]["tema"];
        var nombre = document.forms["contact"]["nombre"];
        var apellido = document.forms["contact"]["apellido"];
