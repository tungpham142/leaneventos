    ...
    <body>
        <header>
            <div id="container">
                ...
                <nav>
                    <ul>
                        <li><a href="<?php echo base_url(); ?>Business" >Incio</a></li>
                        <li><a href="<?php echo base_url(); ?>Business/Profile" class="selected">Fundacion</a></li>
        ...
        <main>
           <section id="individual-main">
            ...
            <section id="contact-form">
                ...
                <form name="update-agent" action="<?php echo base_url(); ?>Business/UpdateProfile" method="POST">    
