        ...
        <main>
           <section id="newevent-main">
            ...
            <section id="contact-form">
                ...
                <form name="create-event" action="<?php echo base_url(); ?>Agent/EventValidate" method="POST">  
                    ...
                    <div class="same-block">
                        ...
                        <input type="text" id="lugar" name="lugar" placeholder="Direccion del Lugar del Eventos required" required>
                    </div>

                    <div class="individual-col profile-form">
                        <label for="fecha">Fecha</label>
                        <input type="date" id="fecha" name="fecha" placeholder="00/00/0000" required>
                    </div>    
                    ...
                    <div class="individual-col profile-form" id="right-form">
                        ...
                        <input type="text" id="boleto" name="boleto" placeholder="$000.00">
                    </div>  
