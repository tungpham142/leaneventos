                ...
                <div class="container">
                    ...
                    <form>
                        ...
                        <?php
                            ...
                            {
                                $eventid = $event["id"];
                                $evenname = $event["firstname"];
                                $responsible = $event["agent"];
                                $address = $event["address"];
                                $date = $event["date"];
                                echo  "<tr>
                                <td id=\"first-col\">
                                    <img src=\"/leaneventos/imagenes/nologo.png\" width=\"120px\" height=\"140px\">
                                    <span>$evenname</span>
                                </td>
                                <td>$address</td>
                                <td>$date</td>
