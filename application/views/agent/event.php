        ...
        <main>
            <section id="list-event">
                <div class="container">
                    ...
                    <div id="add-event">
                        <a href="<?php echo base_url(); ?>Agent/CreateEvent" class="close-btn button" id="add-event-btn">Agregar</a>
                    </div>
                    <form>
                        <table>
                        <tr>
